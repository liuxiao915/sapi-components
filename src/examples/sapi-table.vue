<template>
  <div class="sapi-table">
    <sapi-table :data="state.tableData" height="300px" @rowClick="rowClick" header-row-class-name="project-table-header" :header-row-style="{background: '#2F88F6', color: '#ffffff'}">
