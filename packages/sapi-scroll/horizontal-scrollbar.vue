...
<template>
    <div>
        <div v-if="width < 100" class="sapi-scrollbar__scrollbar-horizontal" ref="container" @click="jump">
            <div :class="'scrollbar' + (dragging || draggingFromParent ? '' : ' sapi-scrollbar-transition')"
                ref="scrollbar" @touchstart="startDrag" @mousedown="startDrag" :style="{
                    width: this.width + '%',
                    left: this.scrolling + '%'
                }">
            </div>
